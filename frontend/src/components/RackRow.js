...
const RackRow = ({ row, stacks, column, fetchRacks, highlightedSpot, setHighlightedSpot, handleSearch, fullSpots }) => { // Accept handleSearch as prop
      ...
      {stackPositions.map(stack => {
        ...
        return (
          <RackSpot
            ...
            fullSpots={fullSpots} // Pass down fullSpots
          />
        );
      })}
    </div>
